...
void ari_lrotatn_usecopy(int a[], int n, int jump); // DONE
void ari_lrotatn_reverse(int a[], int n, int jump); // TODO
...
void ari_rrotatn_usecopy(int a[], int n, int jump); // DONE
